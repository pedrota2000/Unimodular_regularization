...
#NEW directory
directory = '0_7_test_1'
# Parent Directory path 
parent_dir = os.path.dirname(os.path.abspath(__file__))+"/MH_flattening_paper/flat_5_heads/TL"
# Path 
...
load_path = "/home/pablo/NNholo/MH_flattening_paper/flat_5_heads/results_2_more_training/NN_5MH_flat_metric_epochs_3000000"
...
c = NNholo_multihead_heist(transfer_sofT_path=sofT_list[0], phim_list = phim_param,\
...
c.MH_save_results(f'{path_results}/NN_TL_0_7_from_MH_5_heads')
