...
parent_dir = os.path.dirname(os.path.abspath(__file__))+"/MH_results"
# Path 
...
load_path = "/home/pedro/NNholo/MH_flat_paper/MH_results/test_1/NN_MH_heist_epochs_2000000"
...
c = NNholo_multihead_heist(sofT_path_list=sofT_list, phim_list = phim_param,\
           ...
           V_head_arch=V_head, actv_V_head=nn.SiLU, u_sampling='chebyshev2-noisy', n_batches_train=1,load_path = load_path)
...
c.MH_save_results(f'{path_results}/NN_MH_heist')
